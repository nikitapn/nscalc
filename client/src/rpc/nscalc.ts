...
export namespace Flat_nscalc {
export class Vector3_Direct extends NPRPC.Flat.Flat {
  public get x() { return this.buffer.dv.getFloat32(this.offset+0,true); }
  public set x(value: number) { this.buffer.dv.setFloat32(this.offset+0,value,true); }
  public get y() { return this.buffer.dv.getFloat32(this.offset+4,true); }
  public set y(value: number) { this.buffer.dv.setFloat32(this.offset+4,value,true); }
  public get z() { return this.buffer.dv.getFloat32(this.offset+8,true); }
  public set z(value: number) { this.buffer.dv.setFloat32(this.offset+8,value,true); }
}
} // namespace Flat 
...
export namespace Flat_nscalc {
export class Vector2_Direct extends NPRPC.Flat.Flat {
  public get x() { return this.buffer.dv.getFloat32(this.offset+0,true); }
  public set x(value: number) { this.buffer.dv.setFloat32(this.offset+0,value,true); }
  public get y() { return this.buffer.dv.getFloat32(this.offset+4,true); }
  public set y(value: number) { this.buffer.dv.setFloat32(this.offset+4,value,true); }
...
export class Authorizator extends NPRPC.ObjectProxy {
  ...
  public async LogIn(login: /*in*/string, password: /*in*/string): Promise<UserData> {
    ...
    __ch.function_idx = 0;
  let _ = new Flat_nscalc.nscalc_M1_Direct(buf,32);
  _._1 = login;
  _._2 = password;
  ...
  let out = new Flat_nscalc.nscalc_M2_Direct(buf, 16);
  ...
  public async LogInWithSessionId(session_id: /*in*/string): Promise<UserData> {
    ...
    __ch.interface_idx = interface_idx;
    __ch.function_idx = 1;
  let _ = new Flat_nscalc.nscalc_M3_Direct(buf,32);
  _._1 = session_id;
    buf.write_len(buf.size - 4);
    await NPRPC.rpc.call(
      this.endpoint(), buf, this.timeout
  ...
  let out = new Flat_nscalc.nscalc_M4_Direct(buf, 16);
  ...
  public async RegisterStepOne(username: /*in*/string, email: /*in*/string, password: /*in*/string): Promise<void> {
    ...
    __ch.interface_idx = interface_idx;
    __ch.function_idx = 5;
  let _ = new Flat_nscalc.nscalc_M5_Direct(buf,32);
  _._1 = username;
  _._2 = email;
  _._3 = password;
    buf.write_len(buf.size - 4);
  ...
  public async RegisterStepTwo(username: /*in*/string, code: /*in*/number): Promise<void> {
    ...
    __ch.interface_idx = interface_idx;
    __ch.function_idx = 6;
  let _ = new Flat_nscalc.nscalc_M6_Direct(buf,32);
  _._1 = username;
  _._2 = code;
    buf.write_len(buf.size - 4);
    await NPRPC.rpc.call(
...
let __ret_val: UserData;
      ...
      __ret_val = (obj as any).LogIn(ia._1, ia._2);
        ...
        obuf.prepare(24);
        obuf.commit(24);
        let oa = new Flat_nscalc.AuthorizationFailed_Direct(obuf,16);
        oa.__ex_id = 0;
  oa.reason = e.reason;
...
let __ret_val: boolean/*boolean*/;
      ...
      obuf.prepare(17);
      obuf.commit(17);
      let oa = new Flat_nscalc.nscalc_M4_Direct(obuf,16);
  oa._1 = __ret_val;
      obuf.write_len(obuf.size - 4);
      obuf.write_msg_id(NPRPC.impl.MessageId.BlockResponse);
      obuf.write_msg_type(NPRPC.impl.MessageType.Answer);
...
let __ret_val: boolean/*boolean*/;
  ...
  oa._1 = __ret_val;
    ...
    case 5: {
      let ia = new Flat_nscalc.nscalc_M5_Direct(buf, 32);
      try {
      (obj as any).RegisterStepOne(ia._1, ia._2, ia._3);
        ...
        obuf.prepare(24);
        obuf.commit(24);
        let oa = new Flat_nscalc.RegistrationFailed_Direct(obuf,16);
        oa.__ex_id = 1;
  oa.reason = e.reason;
        obuf.write_len(obuf.size - 4);
        obuf.write_msg_id(NPRPC.impl.MessageId.Exception);
    ...
    case 6: {
      let ia = new Flat_nscalc.nscalc_M6_Direct(buf, 32);
      try {
...
export class RegisteredUser extends NPRPC.ObjectProxy {
  ...
  public async GetMyCalculations(calculations: /*out*/NPRPC.ref<NPRPC.Flat.Vector_Direct2<Flat_nscalc.Calculation_Direct>>): Promise<void> {
    let interface_idx = (arguments.length == 1 ? 0 : arguments[arguments.length - 1]);
    let buf = NPRPC.FlatBuffer.create();
    buf.prepare(32);
    buf.commit(32);
  ...
  let out = new Flat_nscalc.nscalc_M7_Direct(buf, 16);
  ...
  public async AddSolution(name: /*in*/string, elements: /*in*/Array<number>/*14*/): Promise<number/*u32*/> {
    ...
    __ch.interface_idx = interface_idx;
    __ch.function_idx = 1;
  let _ = new Flat_nscalc.nscalc_M8_Direct(buf,32);
  _._1 = name;
  ...
  let out = new Flat_nscalc.nscalc_M9_Direct(buf, 16);
  ...
  public async SetSolutionName(id: /*in*/number, name: /*in*/string): Promise<void> {
    ...
    __ch.interface_idx = interface_idx;
    __ch.function_idx = 2;
  let _ = new Flat_nscalc.nscalc_M10_Direct(buf,32);
  _._1 = id;
  _._2 = name;
    buf.write_len(buf.size - 4);
    await NPRPC.rpc.call(
  ...
  public async SetSolutionElements(id: /*in*/number, name: /*in*/Array<SolutionElement>): Promise<void> {
    ...
    __ch.interface_idx = interface_idx;
    __ch.function_idx = 3;
  let _ = new Flat_nscalc.nscalc_M11_Direct(buf,32);
  _._1 = id;
  _._2(name.length);
  {
  ...
  public async DeleteSolution(id: /*in*/number): Promise<void> {
    ...
    __ch.interface_idx = interface_idx;
    __ch.function_idx = 4;
  let _ = new Flat_nscalc.nscalc_M9_Direct(buf,32);
  _._1 = id;
    buf.write_len(buf.size - 4);
    await NPRPC.rpc.call(
      this.endpoint(), buf, this.timeout
...
{
  GetMyCalculations(calculations: NPRPC.Flat.Vector_Direct2<Flat_nscalc.Calculation_Direct>): void;
  ...
  SetSolutionElements(id: number, name: NPRPC.Flat.Vector_Direct2<Flat_nscalc.SolutionElement_Direct>): void;
  ...
  SaveData(): void;
  UpdateCalculation(calculation: Flat_nscalc.Calculation_Direct): number/*u32*/;
...
export class _IRegisteredUser_Servant extends NPRPC.ObjectServant {
  ...
  switch(__ch.function_idx) {
    case 0: {
      ...
      obuf.prepare(152);
      obuf.commit(24);
      let oa = new Flat_nscalc.nscalc_M7_Direct(obuf,16);
    ...
    case 1: {
      let ia = new Flat_nscalc.nscalc_M8_Direct(buf, 32);
let __ret_val: number/*u32*/;
      ...
      obuf.prepare(20);
      obuf.commit(20);
      let oa = new Flat_nscalc.nscalc_M9_Direct(obuf,16);
  oa._1 = __ret_val;
      obuf.write_len(obuf.size - 4);
      obuf.write_msg_id(NPRPC.impl.MessageId.BlockResponse);
      obuf.write_msg_type(NPRPC.impl.MessageType.Answer);
    ...
    case 2: {
      let ia = new Flat_nscalc.nscalc_M10_Direct(buf, 32);
      try {
      (obj as any).SetSolutionName(ia._1, ia._2);
        ...
        obuf.prepare(28);
        obuf.commit(28);
        let oa = new Flat_nscalc.PermissionViolation_Direct(obuf,16);
        oa.__ex_id = 2;
  oa.msg = e.msg;
        obuf.write_len(obuf.size - 4);
        obuf.write_msg_id(NPRPC.impl.MessageId.Exception);
    ...
    case 3: {
      let ia = new Flat_nscalc.nscalc_M11_Direct(buf, 32);
      try {
  ...
  oa.msg = e.msg;
    ...
    case 4: {
      let ia = new Flat_nscalc.nscalc_M9_Direct(buf, 32);
      try {
...
let __ret_val: number/*u32*/;
  ...
  oa.msg = e.msg;
    ...
    case 10: {
      let ia = new Flat_nscalc.nscalc_M12_Direct(buf, 32);
let __ret_val: number/*u32*/;
...
export class DataObserver extends NPRPC.ObjectProxy {
  ...
  public async OnAlarm(alarm: /*in*/Alarm): Promise<void> {
    ...
    __ch.interface_idx = interface_idx;
    __ch.function_idx = 1;
  let _ = new Flat_nscalc.nscalc_M13_Direct(buf,32);
  _._1.id = alarm.id;
  ...
  public async OnFootstep(footstep: /*in*/Footstep): Promise<void> {
    ...
    __ch.interface_idx = interface_idx;
    __ch.function_idx = 2;
  let _ = new Flat_nscalc.nscalc_M14_Direct(buf,32);
...
export interface IDataObserver_Servant
{
  ...
  OnAlarm(alarm: Flat_nscalc.Alarm_Direct): void;
  OnFootstep(footstep: Flat_nscalc.Footstep_Direct): void;
}
...
export class _IDataObserver_Servant extends NPRPC.ObjectServant {
  ...
  switch(__ch.function_idx) {
    ...
    case 1: {
      let ia = new Flat_nscalc.nscalc_M13_Direct(buf, 32);
      (obj as any).OnAlarm(ia._1);
      NPRPC.make_simple_answer(buf, NPRPC.impl.MessageId.Success);
      break;
    }
    case 2: {
      let ia = new Flat_nscalc.nscalc_M14_Direct(buf, 32);
...
export class Chat extends NPRPC.ObjectProxy {
  ...
  public async Send(msg: /*in*/ChatMessage): Promise<boolean/*boolean*/> {
    ...
    __ch.interface_idx = interface_idx;
    __ch.function_idx = 1;
  let _ = new Flat_nscalc.nscalc_M16_Direct(buf,32);
...
export interface IChat_Servant
{
  ...
  Send(msg: Flat_nscalc.ChatMessage_Direct): boolean/*boolean*/;
}
...
export class _IChat_Servant extends NPRPC.ObjectServant {
  ...
  switch(__ch.function_idx) {
    ...
    case 1: {
      let ia = new Flat_nscalc.nscalc_M16_Direct(buf, 32);
let __ret_val: boolean/*boolean*/;
...
{
  OnMessage(msg: Flat_nscalc.ChatMessage_Direct): void;
}
...
export class Calculator extends NPRPC.ObjectProxy {
  ...
  public async GetData(solutions: /*out*/NPRPC.ref<NPRPC.Flat.Vector_Direct2<Flat_nscalc.Solution_Direct>>, fertilizers: /*out*/NPRPC.ref<NPRPC.Flat.Vector_Direct2<Flat_nscalc.Fertilizer_Direct>>): Promise<void> {
    let interface_idx = (arguments.length == 2 ? 0 : arguments[arguments.length - 1]);
    let buf = NPRPC.FlatBuffer.create();
    buf.prepare(32);
    buf.commit(32);
  ...
  let out = new Flat_nscalc.nscalc_M17_Direct(buf, 16);
  solutions.value = out._1_d();
  fertilizers.value = out._2_d();
}

  public async GetImages(images: /*out*/NPRPC.ref<NPRPC.Flat.Vector_Direct2<Flat_nscalc.Media_Direct>>): Promise<void> {
    let interface_idx = (arguments.length == 1 ? 0 : arguments[arguments.length - 1]);
    let buf = NPRPC.FlatBuffer.create();
    buf.prepare(32);
    buf.commit(32);
  ...
  let out = new Flat_nscalc.nscalc_M18_Direct(buf, 16);
  ...
  public async GetGuestCalculations(calculations: /*out*/NPRPC.ref<NPRPC.Flat.Vector_Direct2<Flat_nscalc.Calculation_Direct>>): Promise<void> {
    let interface_idx = (arguments.length == 1 ? 0 : arguments[arguments.length - 1]);
    let buf = NPRPC.FlatBuffer.create();
    buf.prepare(32);
    buf.commit(32);
...
{
  GetData(solutions: NPRPC.Flat.Vector_Direct2<Flat_nscalc.Solution_Direct>, fertilizers: NPRPC.Flat.Vector_Direct2<Flat_nscalc.Fertilizer_Direct>): void;
  GetImages(images: NPRPC.Flat.Vector_Direct2<Flat_nscalc.Media_Direct>): void;
  Subscribe(obj: NPRPC.ObjectProxy): void;
  GetGuestCalculations(calculations: NPRPC.Flat.Vector_Direct2<Flat_nscalc.Calculation_Direct>): void;
  SendFootstep(footstep: Flat_nscalc.Footstep_Direct): void;
}
...
export class _ICalculator_Servant extends NPRPC.ObjectServant {
  ...
  switch(__ch.function_idx) {
    case 0: {
      ...
      obuf.prepare(160);
      obuf.commit(32);
      let oa = new Flat_nscalc.nscalc_M17_Direct(obuf,16);
    ...
    case 1: {
      ...
      obuf.prepare(152);
      obuf.commit(24);
      let oa = new Flat_nscalc.nscalc_M18_Direct(obuf,16);
...
function nscalc_throw_exception(buf: NPRPC.FlatBuffer): void { 
  ...
  case 0:
  {
    let ex_flat = new Flat_nscalc.AuthorizationFailed_Direct(buf, 16);
  ...
  case 1:
  {
    let ex_flat = new Flat_nscalc.RegistrationFailed_Direct(buf, 16);
  ...
  case 2:
  {
    let ex_flat = new Flat_nscalc.PermissionViolation_Direct(buf, 16);
...
export namespace Flat_nscalc {
export class nscalc_M1_Direct extends NPRPC.Flat.Flat {
  public get _1() {
    const offset = this.offset + 0;
    const n = this.buffer.dv.getUint32(offset + 4, true);
    return n > 0 ? u8dec.decode(new DataView(this.buffer.array_buffer, offset + this.buffer.dv.getUint32(offset, true), n)) : ""
...
export namespace Flat_nscalc {
export class nscalc_M2_Direct extends NPRPC.Flat.Flat {
...
export namespace Flat_nscalc {
export class nscalc_M3_Direct extends NPRPC.Flat.Flat {
  public get _1() {
    const offset = this.offset + 0;
    const n = this.buffer.dv.getUint32(offset + 4, true);
    return n > 0 ? u8dec.decode(new DataView(this.buffer.array_buffer, offset + this.buffer.dv.getUint32(offset, true), n)) : ""
...
export namespace Flat_nscalc {
export class nscalc_M4_Direct extends NPRPC.Flat.Flat {
...
export namespace Flat_nscalc {
export class nscalc_M5_Direct extends NPRPC.Flat.Flat {
  public get _1() {
    const offset = this.offset + 0;
    const n = this.buffer.dv.getUint32(offset + 4, true);
    return n > 0 ? u8dec.decode(new DataView(this.buffer.array_buffer, offset + this.buffer.dv.getUint32(offset, true), n)) : ""
...
export namespace Flat_nscalc {
export class nscalc_M6_Direct extends NPRPC.Flat.Flat {
  public get _1() {
    const offset = this.offset + 0;
    const n = this.buffer.dv.getUint32(offset + 4, true);
    return n > 0 ? u8dec.decode(new DataView(this.buffer.array_buffer, offset + this.buffer.dv.getUint32(offset, true), n)) : ""
...
export namespace Flat_nscalc {
export class nscalc_M8_Direct extends NPRPC.Flat.Flat {
  public get _1() {
    const offset = this.offset + 0;
    const n = this.buffer.dv.getUint32(offset + 4, true);
    return n > 0 ? u8dec.decode(new DataView(this.buffer.array_buffer, offset + this.buffer.dv.getUint32(offset, true), n)) : ""
...
export namespace Flat_nscalc {
export class nscalc_M9_Direct extends NPRPC.Flat.Flat {
...
export namespace Flat_nscalc {
export class nscalc_M10_Direct extends NPRPC.Flat.Flat {
  public get _1() { return this.buffer.dv.getUint32(this.offset+0,true); }
  public set _1(value: number) { this.buffer.dv.setUint32(this.offset+0,value,true); }
  public get _2() {
    const offset = this.offset + 4;
...
export namespace Flat_nscalc {
export class nscalc_M11_Direct extends NPRPC.Flat.Flat {
  public get _1() { return this.buffer.dv.getUint32(this.offset+0,true); }
  public set _1(value: number) { this.buffer.dv.setUint32(this.offset+0,value,true); }
  public _2(elements_size: number): void { 
    NPRPC.Flat._alloc(this.buffer, this.offset + 4, elements_size, 16, 8);
  }
  public _2_d() { return new NPRPC.Flat.Vector_Direct2<Flat_nscalc.SolutionElement_Direct>(this.buffer, this.offset + 4, 16, Flat_nscalc.SolutionElement_Direct); }
}
} // namespace Flat 
...
export namespace Flat_nscalc {
export class nscalc_M12_Direct extends NPRPC.Flat.Flat {
...
export namespace Flat_nscalc {
export class nscalc_M13_Direct extends NPRPC.Flat.Flat {
...
export namespace Flat_nscalc {
export class nscalc_M14_Direct extends NPRPC.Flat.Flat {
  public get _1() { return new Footstep_Direct(this.buffer, this.offset + 0); }
}
} // namespace Flat 
...
export namespace Flat_nscalc {
export class nscalc_M15_Direct extends NPRPC.Flat.Flat {
...
export namespace Flat_nscalc {
export class nscalc_M16_Direct extends NPRPC.Flat.Flat {
...
export namespace Flat_nscalc {
export class nscalc_M17_Direct extends NPRPC.Flat.Flat {
  public _1(elements_size: number): void { 
...
export namespace Flat_nscalc {
export class nscalc_M18_Direct extends NPRPC.Flat.Flat {
  public _1(elements_size: number): void { 
    NPRPC.Flat._alloc(this.buffer, this.offset + 0, elements_size, 16, 4);
  }
  public _1_d() { return new NPRPC.Flat.Vector_Direct2<Flat_nscalc.Media_Direct>(this.buffer, this.offset + 0, 16, Flat_nscalc.Media_Direct); }
}
} // namespace Flat 
